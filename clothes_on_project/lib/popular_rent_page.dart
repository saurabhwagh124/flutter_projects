...
class PopularRentPage extends StatefulWidget{
  const PopularRentPage({super.key});

  @override
  State createState() => _PopularRentPageState();
}

class _PopularRentPageState extends State{
  ...
  final TextEditingController _popularityController = TextEditingController(text: "popular");
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [
                          const Spacer(),
                          Text(popuClothes[index].clothesName,style: GoogleFonts.roboto(fontSize: 20, fontWeight: FontWeight.w600),),
                          const Spacer(),
                          const Icon(Icons.favorite_border_outlined, color: Colors.black,size: 30,weight: 16,)
                        ],
                      ),
                      const SizedBox(height: 10,),
                      Image.network(popuClothes[index].clothesUrl,fit: BoxFit.cover),
                      const SizedBox(height: 15,),
                      Row(
                        children: [
                          Text("Price: ${popuClothes[index].price}/day", style: GoogleFonts.roboto(fontSize:20, fontWeight: FontWeight.w500),),
                          const Spacer(),
                          Text("Size: ${popuClothes[index].size}", style: GoogleFonts.roboto(fontSize:20, fontWeight: FontWeight.w500),)
                        ],
                      ),
